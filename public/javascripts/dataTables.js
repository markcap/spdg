...
this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Show _MENU_ surveys",sZeroRecords:"No matching records found",sInfo:"Showing _START_ to _END_ of _TOTAL_ surveys",sInfoEmpty:"Showing 0 to 0 of 0 surveys",sInfoFiltered:"(filtered from _MAX_ total surveys)",sInfoPostFix:"",sSearch:"Search:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Previous",sNext:"Next",sLast:"Last"}};
